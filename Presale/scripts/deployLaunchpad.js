...
async function main() {
  ...
  //Mainnet
  // const locker = "0xdF4E774eE178ab9FDEFCeeB231b254E774632725";
  //testnet
  const locker = "0xceB1870317303cfcC12748c1B2c93a71dDaE6a4e";

  const POOLFACTORY = await hre.ethers.getContractFactory("PoolFactory");
  const PoolFactory = await POOLFACTORY.deploy(
    2,
    2,
    "0xb24BaeAb42B8dE210eE0802Ab8F8265E54285f95",
    locker //Locker
  );
